...
const supplierFileSelectColumns = `
        ...
        COALESCE(sf."CurrentAttemptNumber", statusInfo.attempt_count, 1) AS "currentAttemptNumber",
        ...
        GREATEST(COALESCE(sf."CurrentAttemptNumber", statusInfo.attempt_count, 1), 1) AS "attemptCount",
